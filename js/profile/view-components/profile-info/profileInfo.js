...
class ProfileInfo {
            ...
            <div class="row">
                <div class="col-6 col-lg-4 col-xs-10">
                    <div class="row pe-0">
                        ...
                        ${this.#generateUserInfo(userData, "followersSvg", "followingSvg", this.#generatePostsSvg(), this.#generateLikesSvg())}
                    </div>                    
                </div>
    ...
    #generateUserInfo(userData, followersSvg, followingSvg, postsSvg, likesSvg) {
        return undefined;
    }
