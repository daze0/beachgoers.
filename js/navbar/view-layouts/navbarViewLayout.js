        ...
        <div class="container-fluid py-4">
            <div class="d-flex flex-column flex-md-row w-100 align-items-center justify-content-md-between">
                ...
                <div class="d-flex flex-row flex-md-col mb-2 mb-md-0 ms-2 ms-md-0 me-3 w-100 justify-content-center justify-content-md-end">
                    <a href="feed.php" class="nav-link navbar-color mb-0 me-2 me-md-3 py-1 px-3" title="Home">
                        <span class="bi bi-house-fill fs-3"></span>
                    </a>
                    <a href="profile.php" class="nav-link navbar-color mb-0 me-2 me-md-3 py-1 px-3" title="Profile">
                        <span class="bi bi-person-fill fs-3"></span>
                    </a>
                    ${this.#components["notificationButton"].generateComponent().outerHTML}
                    <a href="#" class="nav-link navbar-color mb-0 ms-2 mx-md-3 py-1 px-3" title="Logout">
